...
def run_code(uni, log):
  ...
  # students not submitting count_cfg_freq.py
  shutil.copy('../../scripts/count_cfg_freq_py3.py', 'count_cfg_freq.py')
  ...
  try:
    ...
    os.system('python ../../scripts/eval_parser_py3.py '
              '../../data/parse_dev.key '
  ...
  fnames = [s.lower() for s in glob.glob('*')]
